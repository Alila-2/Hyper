...
public class PreloadHyperspectralDataResponse {
    ...
    public PreloadHyperspectralDataResponse() {
    }

    public PreloadHyperspectralDataResponse(boolean success, String message, String originalImage, String pseudoColorImage,
                                            int originalWidth, int originalHeight, int pseudoWidth, int pseudoHeight,
                                            int totalBands, List<Integer> visualizationBands) {
