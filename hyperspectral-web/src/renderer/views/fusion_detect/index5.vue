                ...
                <div class="fusion-content">
                    ...
                    <div class="input-section">
                        ...
                        <div class="input-card modal-two" ref="modalTwo">
                            ...
                            <div class="card-content">
                                <!-- 修改：给容器加 msi-preview，图片加 preview-image--msi -->
    ...
    export default {
        ...
        data() {
            return {
                ...
                materials: [
                    ...
                    { name: "竹材", color: "#808000", targets: ["d14"] },
        ...
        methods: {
            ...
            async handleChange1(file) {
                ...
                this.matInfo1 = null;
                this.imageUrl2 = ""; // 清空之前的PNG图像
                this.selectedFile2 = null; // 清空之前的PNG文件
...
<style scoped>
    ...
    /* -------- 新增：仅放大模态二（MSI）的展示，不影响其它图片 -------- */
    .msi-preview {
        max-width: 480px; /* 原 300px -> 480px */
    }

    .preview-image--msi {
        max-height: 360px; /* 原 200px -> 360px */
        border-radius: 10px;
    }
